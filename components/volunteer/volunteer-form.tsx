...
export function VolunteerForm() {
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center rounded-2xl border border-border bg-card p-10 text-center">
        ...
        <h3 className="mt-4 font-heading text-xl font-bold text-navy">Welcome to the team</h3>
        <p className="mt-2 max-w-md text-muted-foreground leading-relaxed">
          Thank you for offering your time. Our volunteer coordinator will be in touch soon to discuss the next steps
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-2xl border border-border bg-card p-6 sm:p-8">
      <h3 className="font-heading text-xl font-bold text-navy">Volunteer application</h3>
      <p className="mt-1 text-sm text-muted-foreground">Tell us a little about yourself and how you would like to help.</p>

      <div className="mt-6 grid gap-5 sm:grid-cols-2">
        <div className="grid gap-2">
          <Label htmlFor="firstName">First name</Label>
          <Input id="firstName" required placeholder="Jane" autoComplete="given-name" />
        </div>
        <div className="grid gap-2">
        ...
        <div className="grid gap-2">
          ...
          <Input id="phone" type="tel" placeholder="+27 82 000 0000" autoComplete="tel" />
        </div>
      </div>
