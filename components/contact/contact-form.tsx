  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center rounded-2xl border border-border bg-card p-10 text-center">
        ...
        <h3 className="mt-4 font-heading text-xl font-bold text-navy">Thank you for reaching out</h3>
        <p className="mt-2 max-w-md text-muted-foreground leading-relaxed">
          Your message has been received. A member of our team will get back to you within one working day. If this is
          an emergency, please call our 24/7 helpline.
        </p>
    ...
    <form onSubmit={handleSubmit} className="rounded-2xl border border-border bg-card p-6 sm:p-8">
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="grid gap-2">
          ...
          <Input id="phone" name="phone" type="tel" placeholder="+27 82 000 0000" autoComplete="tel" />
        </div>
      </div>
      ...
      <Button type="submit" size="lg" className="mt-5 w-full bg-accent text-accent-foreground hover:bg-accent/90 sm:w-auto">
